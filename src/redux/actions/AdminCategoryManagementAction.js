...
export const CreateCategoryAction = (formData, history, token) => async (dispatch) => {
    ...
    await axios.post(`${BASE_URL}/categories/create`, formData, postOptions(token)).then(res => {
...
export const ViewCategoryAction = (id, token) => async (dispatch) => {
    ...
    await axios.get(`${BASE_URL}/categories/view-one/${id}`, getOptions(token)).then(res => {
...
export const UpdateCategoryAction = (formData, id, token) => async (dispatch) => {
    ...
    await axios.post(`${BASE_URL}/categories/update/${id}`, formData, postOptions(token)).then(res => {
...
export const DeleteCategoryAction = (id, token) => async (dispatch) => {
    await axios.delete(`${BASE_URL}/categories/delete/${id}`, getOptions(token)).then(res => {
